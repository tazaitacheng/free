...
@interface HJDropDownMenuTitleButton ()
...
@implementation HJDropDownMenuTitleButton
...
-(void)viewConfig
{
    ...
    CGSize mainTitleSize = [_mainTitle stringSizeWithFont:
                            [UIFont systemFontOfSize:dropDownMenuTitleButtonUIValue()->MAINTITLELABEL_FONT]];
    CGSize subTitleSize = [_subTitle stringSizeWithFont:
